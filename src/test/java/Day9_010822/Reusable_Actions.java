...
public class Reusable_Actions<creating, method, driver> {
    ...
    //creating void Select method for any web element
    public static void SelectMethod(WebDriver driver, String xpath, String elementName){
        //declare local explicit wait
        WebDriverWait wait = new WebDriverWait(driver,15);
        System.out.println("Submitting on element " + elementName);
        try {
    ...
    //creating void scroll Method for any web element
