...
public class DynamicArray {
    ...
    public static void main(String[] args) {
        ...
        //create a String dynamic array for countires
        String[] countries = new String[6]; //you set the limit/boundaries for your aaray
        //now you define your values by variables indexing
        countries[0] = "USA";
        countries[1] = "Canada";
